...
const Card = ({ recipe }) => {
  console.log(recipe);
  return (
    <Link className="bg-white rounded-lg p-4" to={`/recipe/${recipe.id}`}>
      <div className="relative">
        ...
        <p
          className="absolute bottom-1 left-1 bg-white rounded-lg 
        p-1 font-semibold flex items-center gap-2"
        >
          <TbClockHour8 />
