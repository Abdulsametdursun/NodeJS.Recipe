...
const Sidebar = () => {
  return (
    ...
    items-center p-3 max-md:p-2 max-md:gap-20 lg:p-10 max-md:justify-normal"
    >
      <img
      ...
      <div className="flex flex-col justify-center items-center flex-1 gap-20">
        {links.map((item) => (
          <NavLink
            key={item.path}
      ...
      <div className="flex flex-col gap-2 max-md:hidden">
        <p className="font-semibold">Get News</p>
